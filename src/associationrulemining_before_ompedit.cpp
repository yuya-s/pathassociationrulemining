...
void AssociationRules::FindPattern(OriginalGraph graph){
    ...
    VerticesPartitioning(graph, RANDOM);
    ...
    if(PartitionMode!=RANDOM){
        cout<<"Reparitioning :" << PartitionMode<<endl;
        VerticesPartitioning(graph, PartitionMode);
    }
        ...
        while (end != 0) {
            ...
            for (auto &rulevertextuple: candidatetuplesvector) {
                ...
                for(int for_length=0;for_length<maximumpathlength;for_length++){
                    ...
                    if(!EfficientFlag||!ExtentionFlag){
                        if(count!=0&&count>minsupport/graph.maximumIndegree_edgelabel^(for_length)){
...
//                    //matchedvertices[matchedvertexid].patternidentifiers.push_back(temppattern.patternidentifier);
//                }
//                matchedvertexs_attributeset.push_back(matchedvertexids);
    ...
    while(1) {
        ...
        for (int for_path1 = start; for_path1 < end - 1; for_path1++) {
            ...
            for (int for_path2 = for_path1 + 1; for_path2 < end; for_path2++) {
                ...
                Path candidatepath2;
                Path candidatepath3;
                vector<int> pathidentifiers;pathidentifiers.clear();
                vector<int> pathidentifiers1;pathidentifiers1.clear();
                vector<int> pathidentifiers2;pathidentifiers2.clear();
                vector<int> pathidentifiers3;pathidentifiers3.clear();
                bool containFlag1=false;
                ...
                Path path1 =paths[length][for_path1];
                Path path2 = paths[length][for_path2];

                bool mergePosibilityFlag=true;
                ...
                for(int for_length=0; for_length<length+1;for_length++) {
...
//                    }
                    ...
                    while (!combinations.empty()) {
                        ...
                        if(!candidatepath.vertextuples.empty()) {
                            ...
                            if (!pathidentifiers.empty())tempcandidatepaths.push_back(make_pair(candidatepath, pathidentifiers));
                ...
                //if(path1.pathidentifier==129&&path2.pathidentifier==198)return;


//
//                candidatepath1 = MergeTwoLLengthPathSource(paths[length][for_path1],paths[length][for_path2], length, numberOfCandidateAttribute);
//                if(!candidatepath1.vertextuples.empty()) {
//
////                    cout<<"cand1: ";candidatepath1.Show();
////                    paths[length][for_path1].Show();
////                    paths[length][for_path2].Show();
//
//                    for (int for_att = 0; for_att < candidatepath1.vertextuples[0].size(); for_att++) {
...
//                        for (int for_path = start; for_path < end; for_path++) {
//
//                            if (paths[length][for_path] == tmppath) {
//                                containFlag1 = true;
//                                pathidentifiers1.push_back(paths[length][for_path].pathidentifier);
//                                break;
//                            }
//                        }
//                        if (!containFlag1) {
...
//
//
//                candidatepath2 = MergeTwoLLengthPathTarget(paths[length][for_path1],paths[length][for_path2], length, numberOfCandidateAttribute);
//
//                if(!candidatepath2.vertextuples.empty()) {
//
////                    cout<<"cand2: ";candidatepath2.Show();
////                    paths[length][for_path1].Show();
////                    paths[length][for_path2].Show();
//
//                    for (int for_att = 0; for_att < candidatepath2.vertextuples[length].size(); for_att++) {
//
//                        containFlag2 = false;
//
//                        Path tmppath = candidatepath2;
//                        tmppath.vertextuples[length].erase(tmppath.vertextuples[length].begin() + for_att);
//                        //tmppath.Show();
//                        for (int for_path = start; for_path < end; for_path++) {
//
//                            if (paths[length][for_path] == tmppath) {
//                                //paths[1][for_path].Show();
//                                pathidentifiers2.push_back(paths[length][for_path].pathidentifier);
//                                containFlag2 = true;
//                                break;
//                            }
//                        }
...
//                else insertFlag2=false;
//
//                if(!insertFlag1&&!insertFlag2) {
//
//                    candidatepath3 = MergeTwoPathSourceAndTarget(paths[length][for_path1], paths[length][for_path2], numberOfCandidateAttribute);
//
//                    if (!candidatepath3.vertextuples.empty()) {
//
//                        if (candidatepath3.vertextuples[0].size() > numberOfCandidateAttribute || candidatepath3.vertextuples[length].size() > numberOfCandidateAttribute) {
//
////                            cout << "candidate3" << endl;
////                            candidatepath3.Show();
//
//                            for (int for_att1 = 0; for_att1 < candidatepath3.vertextuples[0].size(); for_att1++) {
//                                containFlag3 = false;
//                                Path tmppath1 = candidatepath3;
//
//                                tmppath1.vertextuples[0].erase(tmppath1.vertextuples[0].begin() + for_att1);
//
//                                for (int for_att2 = 0; for_att2 < candidatepath3.vertextuples[length].size(); for_att2++) {
//
//                                    containFlag3 = false;
//
//                                    Path tmppath2 = tmppath1;
//                                    tmppath2.vertextuples[length].erase(tmppath2.vertextuples[length].begin() + for_att2);
//                                    //tmppath.Show();
//                                    for (int for_path = start; for_path < end; for_path++) {
//
//                                        if (paths[length][for_path] == tmppath2) {
//                                            //paths[1][for_path].Show();
//                                            pathidentifiers3.push_back(paths[length][for_path].pathidentifier);
//                                            containFlag3 = true;
//                                            break;
//                                        }
//                                    }
...
//                            }
//
//                            if (insertFlag3)tempcandidatepaths.push_back(make_pair(candidatepath3, pathidentifiers3));
//                        }
//                    }
//                }
            }
        ...
        for(auto& rulepath: candidatepaths){
            ...
            //cout<<"test"<<test<<endl;
//            cout<<" candidate = (";
//            for(int i=0;i<rulepath.first.vertextuples[0].size();i++){
//                cout<<rulepath.first.vertextuples[0][i]<<" ";
//            }
//            cout<<")->"<<rulepath.first.edgelabels[0]<<"-> (";
//            for(int i=0;i<rulepath.first.vertextuples[1].size();i++){
//                cout<<rulepath.first.vertextuples[1][i]<<" ";
//            }
//            cout<<")->"<<rulepath.first.edgelabels[1]<<"-> (";
//            for(int i=0;i<rulepath.first.vertextuples[2].size();i++){
//                cout<<rulepath.first.vertextuples[2][i]<<" ";
//            }
//            cout<<")"<<endl;
...
//                cout<<path.vertextuples[0][0]<<"-"<<for_edgelabel<<"-"<<path0.second[0]<<endl;
                ...
                if (count > minsupport) {
                    ...
                    path.verticalExtendingPathidentifiers.push_back(temppath.pathidentifier);
    ...
    for(int for_targetattribute = 0; for_targetattribute < graph.cardinality_of_vertextuples; for_targetattribute++) {
        ...
        for (int for_edgelabel = 0; for_edgelabel < graph.cardinality_of_edgelabels; for_edgelabel++) {
            ...
            for (int for_length = 0; for_length < maximumpathlength; for_length++) {
                ...
                double x;
                if(for_length==0)x=1;
                else x=(graph.attribute_inverseconnectingcount_edgelabels[for_targetattribute][for_edgelabel]*(graph.maximumIndegree_edgelabel^(for_length-1)));
                //cout<<x<<endl;
...
//    }
    ...
    for(int for_length=1;for_length<maximumpathlength+1;for_length++) {

        for (int for_path1 = 0; for_path1 < paths[for_length].size(); for_path1++) {

            for (int for_path2 = for_path1 + 1; for_path2 < paths[for_length].size(); for_path2++) {

                Path path1 = paths[for_length][for_path1];
                Path path2 = paths[for_length][for_path2];
                ...
                for (int i = 0; i < for_length+1; i++){
                    if (path1.vertextuples[i].size() > 1||path2.vertextuples[i].size() >1) {
                        continueFlag = true;
                        break;
                    }
                }
...
//                if (path2.vertextuples[0].size() > 1 || path2.vertextuples[1].size() > 1)continue;
                ...
                if (CheckPathDominance(path1, path2))continue;
...
//
//    for(int for_pattern=0;for_pattern<patterns.size();for_pattern++) {
//
//        //cout<<for_pattern<<endl;
...
//                }
                ...
                if(CheckPathDominance(expath,path2)){
                    //cout<<"Dominance"<<endl;
                    continue;
                }
                else{
...
//                expath.Show();
                ...
                if(CheckPathDominance(path1,expath)){
                    //cout<<"Dominance"<<endl;
                    continue;
                }
                else{
...
//            std::sort(frequentextendingids1.begin(), frequentextendingids1.end());
//            std::sort(frequentextendingids2.begin(), frequentextendingids2.end());
//
//            vector<pair<int,int>> frequentextendingids;
//            frequentextendingids.clear();
//
//            int pos1=0;
//            int pos2=0;
//
//            while(1){
//
//                //if(pos1==frequentextendingids1.size()||pos2==frequentextendingids2.size())break;
//                if(pos1==frequentextendingids1.size()){
//                    for(int i= pos2; i< frequentextendingids2.size();i ++){
//                        frequentextendingids.push_back(frequentextendingids2[i]);
//                    }
//                    break;
//                }
//                if(pos2==frequentextendingids2.size()){
//                    for(int i= pos1; i< frequentextendingids2.size();i ++){
//                        frequentextendingids.push_back(frequentextendingids1[i]);
//                    }
//                    break;
//                }
//                if(frequentextendingids1[pos1].first==frequentextendingids2[pos2].first){
//                    frequentextendingids.push_back(frequentextendingids1[pos1]);
//                    //frequentextendingids2.erase(frequentextendingids2.begin()+pos2);
//                }
//                else if(frequentextendingids1[pos1].first<frequentextendingids2[pos2].first){
//                    frequentextendingids.push_back(frequentextendingids1[pos1]);
//                    pos1++;
//                }
//                else{
//                    frequentextendingids.push_back(frequentextendingids1[pos2]);
//                    pos2++;
//                }
//            }
//
//
//            for (auto &extendingidentifiers1: frequentextendingids) {
//                for (auto &extendingidentifiers2: frequentextendingids) {
//
//                    if(extendingidentifiers1==extendingidentifiers2)continue;
//
//                    pair<int, int> pathindex1 = pathidentifier2pathsindex[extendingidentifiers1.first];
//                    pair<int, int> pathindex2 = pathidentifier2pathsindex[extendingidentifiers2.first];
//
//                    cout<<"expathid1 ="<<extendingidentifiers1.first<<"("<<pathindex1.first<<","<<pathindex1.second<<endl;
//                    cout<<"expathid2 ="<<extendingidentifiers2.first<<"("<<pathindex2.first<<","<<pathindex2.second<<endl;
//
//                    Path path1 = paths[pathindex1.first][pathindex1.second];
//                    Path path2 = paths[pathindex2.first][pathindex2.second];
//                    if(CheckPathDominance(path1,path2))continue;
...
//                    #pragma omp parallel for
//                    for(int for_core=0;for_core<corenum;for_core++) {
//                        matchedvertexsets[for_core]=PatternVertexMatching_forEfficient(graph, parallelvertexidsets[for_core],extendingidentifiers1.second, extendingidentifiers2.second, extendingidentifiers1.first, extendingidentifiers2.first);
//                    }
//
//                    for(int for_core=0;for_core<corenum;for_core++){
//                        count_s+=matchedvertexsets[for_core].size();
...
//                        temppattern.count = count_s;
//
//                        temppattern.pathidentifiers.push_back(extendingidentifiers1.first);
//                        temppattern.pathidentifiers.push_back(extendingidentifiers2.first);
//
//                        patterns.push_back(temppattern);
//
//                        #pragma omp parallel for
...
//            }
            ...
            //ShowAllPatterns();
            //cout<<"size = "<<patterns.size()<<endl;
            //fout<<for_pattern<<"(" <<pathid1<<","<<pathid2<<") (" <<oripathid1<<","<<oripathid2<<") (" <<path1.pathidentifier<<","<<path2.pathidentifier<<") : "<<combinecount<<endl;
        }
...
//    }
    ...
    for(int for_length1=1;for_length1<maximumpathlength+1;for_length1++){
        ...
        for(int for_length2=for_length1;for_length2<maximumpathlength+1;for_length2++){
            ...
            for(int for_path1 = 0; for_path1 < paths[for_length1].size();for_path1++){
                ...
                for(int for_path2 = start; for_path2 < paths[for_length2].size();for_path2++){
                     ...
                     if (CheckPathDominance(path1, path2)){
                         //cout<<"Dominance"<<endl;
                         continue;
                     }
...
//
//                     if(count_st>minsupport){
//
//                         Pattern temppattern;
//                         temppattern.patternidentifier=patterns.size();
//                         temppattern.count = count_s;
//
//                         if(CheckVertexTupleDominance(path1.vertextuples[0],path2.vertextuples[0])){//the start point of path1 dominates that of path2
//
//                             temppattern.vertextuples.push_back(path1.vertextuples[0]);
//
//                             PatternPath temppatternpath;
//                             temppatternpath.source=0;
//                             temppatternpath.target=1;
//                             temppatternpath.pathidentifier=pathid1;
//                             temppattern.patternedges.push_back(temppatternpath);
//
//                             if(CheckVertexTupleDominance(path1.vertextuples[path1.vertextuples.size()-1],path2.vertextuples[path2.vertextuples.size()-1])){
//                                  temppattern.vertextuples.push_back(path1.vertextuples[path1.vertextuples.size()-1]);
//                             }
//                             else temppattern.vertextuples.push_back(path2.vertextuples[path2.vertextuples.size()-1]);
//
//                             temppatternpath.source=0;
//                             temppatternpath.target=1;
//                             temppatternpath.pathidentifier=pathid2;
//                             temppattern.patternedges.push_back(temppatternpath);
//                         }
//                         else {//the start point of path2 dominates that of path1
//
//                             temppattern.vertextuples.push_back(path2.vertextuples[0]);
//                             PatternPath temppatternpath;
//                             temppatternpath.source=0;
//                             temppatternpath.target=1;
//                             temppatternpath.pathidentifier=pathid2;
...
Path AssociationRules::MergeTwoPathGivenTuples(Path& path1, Path& path2, int givenNumberOfCandidateAttribute, vector<int>& mergetuple) {
    ...
    for(int for_tuples=0;for_tuples<path1.vertextuples.size();for_tuples++){
        ...
        if(Contains(mergetuple, for_tuples)){
...
void AssociationRules::VerticesPartitioning(OriginalGraph & graph, int mode){
